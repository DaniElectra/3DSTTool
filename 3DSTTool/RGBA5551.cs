...
namespace _3DSTTool
{
    ...
    {
        /// <summary>
        /// Encode a given SkiaSharp bitmap into RGBA5551 color
        ...
        /// <summary>
        /// Decode a given RGBA5551 image using given resolution as reference,
        /// and store the result in a SkiaSharp bitmap.
        /// </summary>
        /// <param name="input">The given RGBA5551 image as bytearray.</param>
